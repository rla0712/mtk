...
echo "\033[93;1m +++++++++++++++++++++++++++++++++++"
    ...
    echo "\033[96;1m    {5}  Soal Nomor 5 [O] soal saat ini"
    echo "\033[96;1m    Ketik ctrl+c untuk exit"
echo "\033[93;1m +++++++++++++++++++++++++++++++++++"
sleep 1
echo ""
echo " SILAKAN DI PILIH 5 : "
read -p " ==> " aoc
if [ $aoc = 5 ] || [ $aoc = 05 ];
then
clear
figlet -f slant NOMOR 5 | lolcat
echo "\033[92mSOAL"
echo "\033[93m123456789 - 987654321 + 112233445 -  544332211"
echo -n '\033[96mJawab : '
read a;
fi
if [ $a = '-1296296298' ] || [ $a = '- 1296296298' ];
then
    echo 'Please wait...'
    sleep 1
